...
local lombok_path = home .. "/.local/share/lombok"
local formatter_path = home .. "/.local/share/formatter"

local os_config = jdtls_path .. "/config_linux"
local launcher_jar = vim.fn.glob(jdtls_path .. "/plugins/org.eclipse.equinox.launcher_*.jar")
local lombok_jar = vim.fn.expand(lombok_path .. "/lombok.jar")

local java_formatter = "file://" .. vim.fn.expand(formatter_path .. "/eclipse-java-google-style.xml")
